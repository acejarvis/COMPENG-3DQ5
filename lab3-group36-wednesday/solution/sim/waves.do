...
add wave -hex UUT/PS2_shift_reg
add wave -bin UUT/PS2_code_ready
add wave -bin UUT/PS2_make_code

add wave -divider -height 20 {book-keeping signals}
add wave -uns UUT/max_value
add wave -uns UUT/max_index
add wave -uns UUT/pressed_key_count
add wave -uns UUT/PS2_key_track
